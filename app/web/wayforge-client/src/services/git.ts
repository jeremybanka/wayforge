...
export const OP_commitAll: TransactionOperation = (transactors) => {
...
export const useCommitAll = (): (() => void) =>
  useRecoilTransaction_UNSTABLE((transactors) => () => OP_commitAll(transactors))
...
const OP_makeNewBranch: TransactionOperation = (transactors) => {
...
export const useMakeNewBranch = (): (() => void) =>
  useRecoilTransaction_UNSTABLE(
    (transactors) => () => OP_makeNewBranch(transactors)
  )
