...
- 6f5afb3: 🐛 Fixed bug from the 0.46.30 release where the external signature to `subscribe()` for the timeline overload was not correctly updated to use the new `TimelineUpdate` type.
