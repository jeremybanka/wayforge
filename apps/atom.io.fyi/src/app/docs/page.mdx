...
Keen readers may realize that collections generally extend `Object`, and that `Object` is **not** primitive. If you use a lot of collections in your store, or your collections change frequently, you may consider using `mutable` atoms for them. More on this in the advanced section.
