...
If you need to update state frequently, keep it primitive when you can.
...
Keen readers may recognize that collections generally extend `Object`, and that `Object` is **not** primitive. If you use a lot of collections in your store, or if those collections change frequently, you may want to use `mutable` atoms for them. More on this in the advanced section.
