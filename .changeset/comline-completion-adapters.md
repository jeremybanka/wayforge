...
Add helpers to update and remove completion setup blocks using comment delimiters. Match delimiters independently of indentation and whitespace, preserve surrounding configuration, replace duplicate blocks, and reject unmatched delimiters.
